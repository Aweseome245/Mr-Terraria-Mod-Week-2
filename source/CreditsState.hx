...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			['Mr Terraria Dev Team'],
			['Some Kid',		'some-kid',		'Artist, director and storywriter of the mod',					'https://www.youtube.com/watch?v=dQw4w9WgXcQ',	'228B22'],
			['Aweseome245',		'aweseome245',		'Programmer, animator, composer and charter of the mod',					'https://www.youtube.com/channel/UCnUPPfv1qG2UmmL4ywxM7VQ',	'0047AB'],
			[''],
			['Psych Engine Team'],
